...
const EditPhotoModal: React.FC<EditPhotoModalProps> = ({ visible, photos, address, onClose, onReplace, onDelete, onAdd }) => {
    ...
    >
      <View style={styles.centeredView}>
        <View style={styles.modalView}>
          ...
          <Button text="Close" onPress={onClose} color="#f44336" style={styles.buttonSpacing} />
        </View>
      </View>
      {selectedPhoto && (
